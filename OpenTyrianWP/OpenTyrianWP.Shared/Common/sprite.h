...
static __inline Sprite *sprite( unsigned int table, unsigned int index )
{
...
static __inline bool sprite_exists( unsigned int table, unsigned int index )
{
	return (sprite(table, index)->data != NULL);
}
static __inline Uint16 get_sprite_width( unsigned int table, unsigned int index )
{
	return (sprite_exists(table, index) ? sprite(table, index)->width : 0);
}
static __inline Uint16 get_sprite_height( unsigned int table, unsigned int index )
{
