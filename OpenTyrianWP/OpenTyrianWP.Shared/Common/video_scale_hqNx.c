...
__inline void interp1(Uint32 *pc, Uint32 c1, Uint32 c2)
{
	*pc = (c1*3+c2) >> 2;
}

__inline void interp2(Uint32 *pc, Uint32 c1, Uint32 c2, Uint32 c3)
{
	*pc = (c1*2+c2+c3) >> 2;
}

__inline void interp3(Uint32 *pc, Uint32 c1, Uint32 c2)
{
	//*((int*)pc) = (c1*7+c2)/8;
...
__inline void interp4(Uint32 *pc, Uint32 c1, Uint32 c2, Uint32 c3)
{
...
__inline void interp5(Uint32 *pc, Uint32 c1, Uint32 c2)
{
	*pc = (c1+c2) >> 1;
}

__inline void interp6(Uint32 *pc, Uint32 c1, Uint32 c2, Uint32 c3)
{
	//*pc = (c1*5+c2*2+c3)/8;
...
__inline void interp7(Uint32 *pc, Uint32 c1, Uint32 c2, Uint32 c3)
{
	//*pc = (c1*6+c2+c3)/8;
...
__inline void interp8(Uint32 *pc, Uint32 c1, Uint32 c2)
{
	//*pc = (c1*5+c2*3)/8;
...
__inline void interp9(Uint32 *pc, Uint32 c1, Uint32 c2, Uint32 c3)
{
	//*pc = (c1*2+(c2+c3)*3)/8;
...
__inline void interp10(Uint32 *pc, Uint32 c1, Uint32 c2, Uint32 c3)
{
	//*pc = (c1*14+c2+c3)/16;
...
__inline bool diff(unsigned int w1, unsigned int w2)
{
